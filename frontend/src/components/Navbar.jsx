...
const Navbar = () => {
  ...
  return (
    <div className='w-full h-20  shadow-lg flex justify-between items-center px-3'>
        ...
        <button className='border-2 h-12 border-orange-500 font-bold bg-white text-orange-500 px-4  hover:bg-orange-500 hover:text-white hover:border-white rounded-[999px]' onClick={handleButtonClick}>{buttonText}</button>
    </div>
  )
}
